...
const _Device = _interopRequireDefault(require('./Device'))
...
const Devices = /* #__PURE__*/function(_EventEmitter) {
    _inherits(Devices, _EventEmitter)

    const _super = _createSuper(Devices)
    ...
    function Devices () {
        ...
        _this.pcsc.on('reader', function(reader) {
            const device = new _Device['default'](reader)
